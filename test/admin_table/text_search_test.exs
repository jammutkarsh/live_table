defmodule AdminTable.FilterTest do
  ...
  describe "apply_text_search/3" do
    test "returns true condition when search term is empty" do
      ...
      conditions = AdminTable.Filter.apply_text_search("", fields)
    ...
    test "applies text search to query in base schema" do
      ...
      conditions = AdminTable.Filter.apply_text_search("search term", fields)
    ...
    test "applies text search to joined query" do
      ...
      result = AdminTable.Filter.apply_filters(query, filters, fields)
